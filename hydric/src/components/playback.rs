...
#[component]
pub fn Playback(track: Memo<Track>, supersaw_config: Memo<SupersawConfig>, resonant_freq: RwSignal<f32>, resonance_q: RwSignal<f32>, resonance_wet: RwSignal<f32>) -> impl IntoView {
